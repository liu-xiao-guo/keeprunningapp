...
UBUNTU_TRANSLATION_DOMAIN="keeprunningapp.liu-xiao-guo"
...
aptest.commands = bash $$PWD/keeprunningapp/tests/autopilot/run
aptest.depends  = sub-keeprunningapp

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/keeprunningapp/tests/unit
unittest.depends  = sub-keeprunningapp
